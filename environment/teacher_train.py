    ...
    for i in range(126):
        if i % 25 == 0 and i != 0:
            ...
            for e in range(EPISODES):
                count += 1
                print_game = (count == 0 or (count > 70 and count < 75) or count > 140)
                if print_game:
                    print("count is " + str(count) + "so printing stuff!")
                ...
                while True:
                    ...
                    if print_game:
                        print("student suggested move: ")
                        print(possible_actions[dqn_move_index])
                    ...
                    if e % 25 == 0:
                        filename = 'save/teacher.h5' ## print stuff
                        teacher_agent.save(filename)
